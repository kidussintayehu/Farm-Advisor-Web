...
import sensor from '../../Assets/Images/farmer.jpg'
              ...
              <div class = " absolute justify-center items-center pt-[4.9rem]">
                ...
                <div class = "flex flex-col pt-8">
                  <form class = "">
                    ...
                    {location ? (
                      <div className="container md:w-[22rem] flex flex-col divide-y md:divide-solid divide-gray-300 p-6 rounded-lg bg-white shadow-md  ">
                      <div class = "flex flex-row  justify-between  mb-4 rounded">
                          <p>location name</p>
                          {console.log(searchedData)}
                        <button onClick = {() => setLocation(false)}>
                          <ClearIcon/>
                        </button>
                      </div>
                      <div class = "pt-3">       
                        <img class = "w-[22rem] rounded-lg" src = {sensor}/>
                      </div>
                    </div>
                    ):(
                    <div class="container rounded-lg shadow-md  bg-white divide-y md:divide-solid mb-10">
                      <div class = "flex flex-row justify-between  mb-4 rounded">
                        ...
                        <button onClick = {() => setLocation(current => !current)}>
                      ...
                      <div>
                        {data.filter((val)=>{
                           if(val.first_name.toLowerCase().includes(search.toLowerCase())){
                            ...
                            return(
                            <button class = 'text-gray-700 text-left font-bold' onClick = {() => setLocation(current => !current)}>
